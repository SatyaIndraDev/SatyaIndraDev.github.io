                ...
                <VStack mt='70px' spacing={10}>
                    <div className="github-stats" style={{ width: '100%' }}>
                        ...
                        <div
                            ...
                            style={{ cursor: 'pointer', marginBottom: '30px', height: '200px', background: '#E0EFF8', borderRadius: '10px', boxShadow: 'none', border: 'none' }}
                        >
                            <img
                        ...
                        <div
                            ...
                            style={{ cursor: 'pointer', height: '200px', background: '#E0EFF8', borderRadius: '10px', boxShadow: 'none', border: 'none' }}
                        >
                            <img
