      ...
      <>
        ...
        >
          ...
          <DrawerContent display = {{base : 'block','836px' : 'none'}} bg = 'rgb(1, 16, 27)' color = 'white'>
            <DrawerCloseButton _hover = {{background : 'white;'}} />
              ...
              {/* <Input placeholder='Type here...' /> */}
                ...
                <Stack spacing = '20px'>
                    ...
                    return <ScrollLink key = {Math.random()} to={el.id} smooth={true} duration={300}>
                            ...
                            <Text _hover = {{cursor : 'pointer',color : 'white', borderBottom : '2px solid' , borderColor : 'rgb(224, 247, 250)'}} px = '2' py = '1' fontWeight={600}>{el.text}</Text>
